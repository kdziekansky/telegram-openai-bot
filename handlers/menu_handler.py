...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    [KeyboardButton(get_text("menu_reminders", language)), KeyboardButton(get_text("menu_notes", language))],  # Новая строка
    [KeyboardButton(get_text("menu_themes", language)), KeyboardButton(get_text("menu_export", language))],  # Новая строка
